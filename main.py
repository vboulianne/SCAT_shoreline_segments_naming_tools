...
shorelineToProcess = r"C:\GIS\Shoreline\shln_bay_of_fundy.shp"

referenceGrid = r"C:\GIS\Shoreline\Data\nts_snrc\nts_snrc_50k.shp"
...
listSet = set(valuesList)
sectorList = list(listSet)
...
for sector in sectorList
    ...
    with arcpy.Select_analysis(in_features="work_shln_bay_of_fundy_withGrid", "segmentsWithinGridSector", where_clause='"NTS_SNRC" = '' + sector + '') as cursor:
